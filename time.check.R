...
for (seed in c(1, 2, 3)) {
  ...
  r50   <- adj_bivariate(within(mi_biv, draws <- draws[1:50,   ]), delta=1)$Estimate[1]
  r200   <- adj_bivariate(within(mi_biv, draws <- draws[1:200,  ]), delta=1)$Estimate[1]
  r1000 <- adj_bivariate(mi_biv, delta=1)$Estimate[1]
